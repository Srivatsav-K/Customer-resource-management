...
router.get('/users/status', userControllers.isNew)
router.post('/users/admin/signup', userControllers.adminRegistration)
router.post('/users/employee/signup', authenticateUser, authorizeUser, userControllers.employeeRegistration)
router.post('/users/login', userControllers.login)
router.get('/users/account', authenticateUser, userControllers.account)
router.put('/users/update-account', authenticateUser, userControllers.updateDetails)
router.put('/users/change-password', authenticateUser, userControllers.changePassword)

//company details
router.get('/api/company', authenticateUser, companyControllers.details)
router.post('/api/company', authenticateUser, authorizeUser, companyControllers.create)
router.put('/api/company/:id', authenticateUser, authorizeUser, companyControllers.update)
router.delete('/api/company/:id', authenticateUser, authorizeUser, companyControllers.destroy)
...
router.post('/api/products', authenticateUser, authorizeUser, productsControllers.create)
router.put('/api/products/:id', authenticateUser, authorizeUser, productsControllers.update)
router.delete('/api/products/:id', authenticateUser, authorizeUser, productsControllers.destory)
...
router.delete('/api/clients/:id', authenticateUser, authorizeUser, clientControllers.destroy)
...
router.delete('/api/contacts/:id', authenticateUser, authorizeUser, contactControllers.destroy)

//enquiry
router.get('/api/enquiries', authenticateUser, enquiryControllers.list)
router.get('/api/enquiries/all', authenticateUser, authorizeUser, enquiryControllers.listAll)
...
router.delete('/api/enquiries/:id', authenticateUser, authorizeUser, enquiryControllers.destroy)

//quotation
router.get('/api/quotations', authenticateUser, quotationControllers.list)
router.get('/api/quotations/all', authenticateUser, authorizeUser, quotationControllers.listAll)
...
router.delete('/api/quotations/:id', authenticateUser, authorizeUser, quotationControllers.destroy)

//order
router.get('/api/orders', authenticateUser, orderControllers.list)
router.get('/api/orders/all', authenticateUser, authorizeUser, orderControllers.listAll)
...
router.delete('/api/orders/:id', authenticateUser, authorizeUser, orderControllers.destroy)
...
router.delete('/api/tasks/:id', authenticateUser, authorizeUser, taskControllers.destroy)
